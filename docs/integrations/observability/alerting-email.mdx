...
If you prefer to have multiple email while using the env to set it you can do like this : 

```yaml
  to_emails:
    - "{{env_var('MAIL_RECEIVERS')}}"
```

Your env value :
```
MAIL_RECEIVERS="mail-one@test.com,mail-two@test.com"
```
